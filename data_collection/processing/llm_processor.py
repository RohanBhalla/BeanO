...
# Import models
try:
    from ..crawling.data_models.models import CoffeeBean, BeanInfo, SpecialtyBeanInfo, MenuItem, CafeMenu, ScrapedData
except ImportError:
    from data_collection.crawling.data_models.models import CoffeeBean, BeanInfo, SpecialtyBeanInfo, MenuItem, CafeMenu, ScrapedData
